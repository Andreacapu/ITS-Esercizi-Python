class Movie:
    ...
    def rent(self) -> None:
        if self.is_rented:
            print("Il film non è stato noleggatiato")
        else:
            self.is_rented = True
    
    def return_movie(self) -> None:
        if not self.is_rented:
            print("Errore, il film non è in noleggio")
        else:
...
class Customer:
    ...
    def rent_movie(self, movie:Movie)-> None:
        if movie.is_rented:
            print("Erorre il film è già stato affiliato a qualcuno")
        else:
            movie.rent()
    ...
    def return_movie(self,movie:Movie) -> None:
        if movie in self.rented_movies:
            ...
            print("Errore, il cliente non ha noleggiato quel film")
...
class VideoRentalStore:
    ...
    def regular_customer(self, customer_id: str, name:str)-> None:
    ...
    def rent_movie(self, customer_id:str, movie_id: str) -> None:
        if movie_id in self.movies and customer_id in self.customers:
            ...
            print("Cliente o file non trovato")
    ...
    def get_all_movies(self) -> list[Movie]:
        '''
        la funzione deve restituire la lista di tutti i film affiliati ad ongi cliente del video
        videonoleggio
        '''
